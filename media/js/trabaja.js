...
var preguntas = [['¿Con qué botón se acerca la mira del sniper?','','<div class="radio"><label class="opcion"><input type="radio" name="optradio" value="1"> Rueda del mouse</label></div><div class="radio"><label class="opcion"><input type="radio" name="optradio" value="2"> Click derecho</label></div><div class="radio"><label class="opcion"><input type="radio" name="optradio" value="3"> Click Izquierdo</label></div><div class="radio"><label class="opcion"><input type="radio" name="optradio" value="4"> La tecla S</label></div>','2'],
		...
		['En la imagen, verás uno de los trabajos más raros del mundo, dinos cuál es:','../media/img/preg6.png','<div class="radio"><label class="opcion"><input type="radio" name="optradio" value="1"> Buzo profesional de charcos.</label></div><div class="radio"><label class="opcion"><input type="radio" name="optradio" value="2">  Recogedor de pelotas de golf bajo el agua.</label></div><div class="radio"><label class="opcion"><input type="radio" name="optradio" value="3"> Anfibio en horas libres.</label></div><div class="radio"><label class="opcion"><input type="radio" name="optradio" value="4"> Buzo de rio.</label></div>','2'],
		...
		['El sistema de pensiones en el Perú se divide en: AFP y ONP.','','<div class="radio"><label class="opcion"><input type="radio" name="optradio" value="1"> AFP y ONT</label></div><div class="radio"><label class="opcion"><input type="radio" name="optradio" value="2"> AFP y ONP</label></div><div class="radio"><label class="opcion"><input type="radio" name="optradio" value="3"> APF Y ONC</label></div><div class="radio"><label class="opcion"><input type="radio" name="optradio" value="4"> APF Y ONP</label></div>','2']];
